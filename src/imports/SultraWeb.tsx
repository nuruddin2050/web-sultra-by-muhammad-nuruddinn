import svgPaths from "./svg-a0ogha0deo";
...
function Container() {
  return (
    <div className="bg-[#f0b100] relative rounded-[2.23696e+07px] shrink-0 size-[48px]" data-name="Container">
...
function Header() {
  return (
    <div className="absolute bg-[#1e3a5f] box-border content-stretch flex h-[80px] items-center justify-between left-0 px-[80px] py-0 top-0 w-[896px]" data-name="Header">
      <Container4 />
      <Button />
    </div>
  );
...
function Component1() {
  return (
    <div className="absolute bg-[#fef9c2] content-stretch flex items-center justify-center left-[128px] rounded-[2.23696e+07px] size-[96px] top-0" data-name="001">
      <Icon1 />
    </div>
  );
}
...
function Perizinan() {
  return (
    <div className="[grid-area:1_/_1] place-self-stretch relative shrink-0" data-name="perizinan">
      <Component1 />
      <Heading2 />
      <Paragraph />
    </div>
...
function Container5() {
  return (
    <div className="absolute bg-blue-100 content-stretch flex items-center justify-center left-[128px] rounded-[2.23696e+07px] size-[96px] top-0" data-name="Container">
      <Icon2 />
    </div>
  );
}
...
function Pajak() {
  return (
    <div className="[grid-area:1_/_2] place-self-stretch relative shrink-0" data-name="pajak">
      <Container5 />
      <Heading4 />
      <Paragraph1 />
    </div>
...
function Container6() {
  return (
    <div className="absolute bg-[#fef9c2] content-stretch flex items-center justify-center left-[128px] rounded-[2.23696e+07px] size-[96px] top-0" data-name="Container">
      <Icon3 />
    </div>
  );
}
...
function Kesehatan() {
  return (
    <div className="[grid-area:2_/_1] place-self-stretch relative shrink-0" data-name="kesehatan">
      <Container6 />
      <Heading5 />
      <Paragraph2 />
    </div>
...
function Container7() {
  return (
    <div className="absolute bg-gray-100 content-stretch flex items-center justify-center left-[128px] rounded-[2.23696e+07px] size-[96px] top-0" data-name="Container">
      <Icon4 />
    </div>
  );
}
...
function Edukasi() {
  return (
    <div className="[grid-area:2_/_2] place-self-stretch relative shrink-0" data-name="edukasi">
      <Container7 />
      <Heading6 />
      <Paragraph3 />
    </div>
...
function EServices() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[48px] h-[572px] items-start left-0 pb-0 pt-[64px] px-[80px] top-[580px] w-[896px]" data-name="EServices">
      <Heading1 />
      <ELayanan />
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-gray-200 relative rounded-[2.23696e+07px] shrink-0 size-[32px]" data-name="Button">
...
function Button2() {
  return (
    <div className="basis-0 bg-[#f0b100] grow h-[32px] min-h-px min-w-px relative rounded-[2.23696e+07px] shrink-0" data-name="Button">
...
function ImageWithFallback() {
  return (
    <div className="absolute h-[192px] left-0 top-0 w-[356px]" data-name="ImageWithFallback">
...
function Container11() {
  return (
    <div className="[grid-area:1_/_1] bg-white overflow-clip place-self-stretch relative rounded-[10px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] shrink-0" data-name="Container">
      <Heading8 />
      <Container10 />
    </div>
  );
...
function Container13() {
  return (
    <div className="[grid-area:1_/_2] bg-white overflow-clip place-self-stretch relative rounded-[10px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] shrink-0" data-name="Container">
      <Heading9 />
      <Container12 />
    </div>
  );
...
function Berita() {
  return (
    <div className="[grid-area:1_/_1] content-stretch flex flex-col gap-[24px] items-start place-self-stretch relative shrink-0" data-name="berita">
      <Container9 />
      <Container14 />
      <Container20 />
    </div>
...
function Button5() {
  return (
    <div className="bg-[#f0b100] relative rounded-[2.23696e+07px] shrink-0 size-[32px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex items-center justify-center relative size-[32px]">
        <Icon9 />
      </div>
    </div>
...
function BeritaTerkinieh() {
  return (
    <div className="[grid-area:2_/_1] bg-white place-self-stretch relative rounded-[10px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] shrink-0" data-name="berita terkinieh">
...
function Button6() {
  return (
    <div className="absolute bg-[#f0b100] h-[40px] left-[32px] rounded-[2.23696e+07px] top-[260px] w-[183.25px]" data-name="Button">
...
function Almaz() {
  return (
    <div className="bg-gray-100 box-border grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[repeat(1,_minmax(0px,_1fr))] h-[332px] overflow-clip relative rounded-[10px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="almaz">
      <Container22 />
      <Container23 />
    </div>
  );
...
function BagianGubernur() {
  return (
    <div className="absolute bg-white box-border content-stretch flex flex-col gap-[48px] h-[544px] items-start left-0 pb-0 pt-[64px] px-[80px] top-[2108px] w-[896px]" data-name="bagian gubernur">
      <Heading12 />
      <Almaz />
    </div>
  );
...
function Link7() {
  return (
    <div className="bg-[#364153] relative rounded-[2.23696e+07px] shrink-0 size-[40px]" data-name="Link">
...
function Link10() {
  return (
    <div className="basis-0 bg-[#364153] grow h-[40px] min-h-px min-w-px relative rounded-[2.23696e+07px] shrink-0" data-name="Link">
...
function Footer() {
  return (
    <div className="absolute bg-[#1e3a5f] box-border content-stretch flex flex-col gap-[32px] h-[352.667px] items-start left-0 pb-0 pt-[48px] px-[80px] top-[2652px] w-[896px]" data-name="Footer">
      <KontakUs />
      <HakCipta />
    </div>
  );
...
function Bagian1() {
  return (
    <div className="absolute h-[500px] left-0 top-0 w-[896px]" data-name="bagian 02">
...
function Heading() {
  return (
    <div className="absolute font-['Inter:Bold',sans-serif] font-bold h-[96px] leading-[48px] left-0 not-italic text-[48px] text-nowrap text-white top-0 w-[620.656px] whitespace-pre" data-name="Heading 1">
      <p className="absolute left-0 top-[-5px]">SELAMAT DATANG DI</p>
      <p className="absolute left-0 top-[43px]">SULAWESI TENGGARA</p>
    </div>
  );
}
...
function Paragraph6() {
  return (
    <div className="absolute h-[28px] left-0 top-[112px] w-[620.656px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[28px] left-0 text-[20px] text-nowrap text-white top-[-2.33px] whitespace-pre">Membangun Masa Depan, Melestarikan Budaya, Melayani Masyarakat.</p>
    </div>
  );
}
...
function Button7() {
  return (
    <div className="absolute border-2 border-solid border-white h-[52px] left-0 rounded-[2.23696e+07px] top-[172px] w-[220.688px]" data-name="Button">
...
function Component() {
  return (
    <div className="absolute h-[500px] left-0 overflow-clip top-[80px] w-[896px]" data-name="001">
      <Bagian1 />
      <Bagian />
    </div>
  );
...
export default function SultraWeb() {
  return (
